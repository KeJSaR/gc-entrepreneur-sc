...
// #############################################################################
    ...
    $('#aside-content label').click(function() {
        ...
        var supplierId    = $(this).children('input').val();
        var supplierAlias = $(this).text();
        ...
        $.ajax({
            ...
            addValue($('#update-city'),        obj.supplier_city);
            addValue($('#update-alias'),       obj.supplier_alias);
            addValue($('#update-phone'),       obj.supplier_phone);
            addValue($('#update-address'),     obj.supplier_address);
            addValue($('#update-comment'),     obj.supplier_comment);
            addValue($('#update-supplier-id'), supplierId);

            $('#delete-supplier-alias').html(supplierAlias);
            addValue($('#delete-supplier-id'), supplierId);
