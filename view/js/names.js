...
// #############################################################################
    ...
    var class_id   = $("#aside-content p.active").data("classId");
    var class_name = $("#aside-content p.active").text();

    $('#parent-class').val(class_id);
    $('#parent-class-name').html(class_name);

    $("#section-content label").click(function(){
        var name_id    = $(this).children("input").val();
        var name_alias = $(this).text();

        $('#change-name').val(name_id);
        $('#delete-name').val(name_id);
        $('#change-name-alias').html(name_alias);
        $('#delete-name-alias').html(name_alias);

        $('#new-name-alias').val(name_alias);
        $('#new-name-alias').text(name_alias);
    });
